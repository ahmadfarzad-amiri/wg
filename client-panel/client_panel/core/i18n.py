...
_STRINGS = {
    "fa": {
        ...
        "page.sub_link": "لینک اشتراک",
        "page.not_found": "صفحه پیدا نشد",
        "page.error": "خطا",
        "page.forbidden": "مجاز نیست",
        "sub.title": "لینک اشتراک VPN",
        "sub.hint": "این لینک را می‌توانید در اپلیکیشن‌های سازگار استفاده کنید.",
        "sub.your_link": "لینک اشتراک شما",
        "sub.link_hint": "این لینک کانفیگ WireGuard شما را به‌صورت مستقیم برمی‌گرداند.",
        "sub.copy": "کپی",
        "sub.security_warning": "این لینک را فقط با دستگاه‌های خودتان به اشتراک بگذارید. هر کس این لینک را داشته باشد می‌تواند کانفیگ شما را دانلود کند.",
        "sub.rotate_title": "بازسازی لینک",
        "sub.rotate_hint": "اگر لینک شما لو رفته، می‌توانید آن را باطل کنید و لینک جدید بگیرید.",
        "sub.rotate_confirm": "آیا مطمئنید؟ لینک قدیمی از کار می‌افتد.",
        "sub.rotate_btn": "باطل کردن و دریافت لینک جدید",
        "sub.rotated": "لینک اشتراک جدید صادر شد.",
        ...
        "dashboard.tools_title": "ابزارها",
        "dashboard.download_zip": "دانلود همه کانفیگ‌ها",
        "dashboard.sub_link": "لینک اشتراک",
        "dashboard.data_usage": "مصرف حجم",
        "dashboard.subscription_period": "مدت اشتراک",
        "dashboard.plan_period": "مدت پلن",
        "dashboard.import_link_title": "لینک ورود خودکار",
        "dashboard.import_link_hint": "برای اپ‌هایی که از لینک اشتراک پشتیبانی می‌کنند. با لینک مدت پلن فرق دارد.",
        "dashboard.pending_cta": "رفتن به پشتیبانی",
        "dashboard.inactive_hint": "از پشتیبانی درخواست فعال‌سازی بفرستید.",
        "dashboard.inactive_cta": "درخواست فعال‌سازی",
        "dashboard.no_config_hint": "منتظر بمانید تا ادمین یک کانفیگ به حساب شما اختصاص دهد.",
        "dashboard.no_config_cta": "رفتن به پشتیبانی",
        ...
        "support.conn_test_title": "وضعیت سرور",
        "support.conn_test_hint": "وضعیت رابط WireGuard، دسترسی به سرور خروجی و DNS را روی سرور بررسی می‌کند — نه اتصال گوشی شما.",
        "support.conn_test_btn": "بررسی وضعیت سرور",
        "js.conn_test.wg_interface": "WireGuard",
        "js.conn_test.exit_ping": "سرور خروجی",
        "js.conn_test.dns": "DNS",
        "js.conn_test.up": "بالا",
        "js.conn_test.ok": "سالم",
        "js.conn_test.down": "پایین",
        "js.conn_test.fail": "ناموفق",
        "js.conn_test.error": "خطا",
        "js.conn_test_error": "بررسی وضعیت سرور ناموفق بود",
        "status.primary_config": "کانفیگ اصلی: {name}",
        ...
        "request.submitted": "درخواست شما ثبت شد.",
        ...
        "setup.ios_apps": "اپ WireGuard از App Store",
        ...
        "setup.android_apps": "اپ WireGuard از Google Play",
        ...
        "setup.windows_apps": "WireGuard از wireguard.com",
        ...
        "setup.macos_apps": "اپ WireGuard از App Store",
        ...
        "setup.linux_apps": "WireGuard از بسته‌های سیستم",
        ...
        "dashboard.xray_apps_hint": "برای این لینک‌ها از Hiddify یا v2rayNG استفاده کنید — نه اپ WireGuard.",
    ...
    "en": {
        ...
        "page.sub_link": "Subscription link",
        "page.not_found": "Page not found",
        "page.error": "Error",
        "page.forbidden": "Not allowed",
        "sub.title": "VPN Subscription Link",
        "sub.hint": "Use this link in compatible apps to auto-import your config.",
        "sub.your_link": "Your subscription link",
        "sub.link_hint": "This link returns your WireGuard config directly as a text file.",
        "sub.copy": "Copy",
        "sub.security_warning": "Only share this link with your own devices. Anyone who has it can download your config.",
        "sub.rotate_title": "Regenerate link",
        "sub.rotate_hint": "If your link was compromised, you can revoke it and get a new one.",
        "sub.rotate_confirm": "Are you sure? The old link will stop working.",
        "sub.rotate_btn": "Revoke and get new link",
        "sub.rotated": "A new subscription link has been issued.",
        ...
        "dashboard.tools_title": "Tools",
        "dashboard.download_zip": "Download all configs",
        "dashboard.sub_link": "Subscription link",
        "dashboard.data_usage": "Data usage",
        "dashboard.subscription_period": "Subscription period",
        "dashboard.plan_period": "Plan period",
        "dashboard.import_link_title": "Import link",
        "dashboard.import_link_hint": "For apps that support subscription URLs. This is not your plan expiry.",
        "dashboard.pending_cta": "Go to Support",
        "dashboard.inactive_hint": "Send an enable request from Support.",
        "dashboard.inactive_cta": "Request enable",
        "dashboard.no_config_hint": "Wait for an admin to assign a WireGuard config to your account.",
        "dashboard.no_config_cta": "Go to Support",
        ...
        "support.conn_test_title": "Server status",
        "support.conn_test_hint": "Checks WireGuard interface, exit reachability, and DNS on the server — not whether your phone is online.",
        "support.conn_test_btn": "Check server status",
        "js.conn_test.wg_interface": "WireGuard",
        "js.conn_test.exit_ping": "Exit server",
        "js.conn_test.dns": "DNS",
        "js.conn_test.up": "up",
        "js.conn_test.ok": "ok",
        "js.conn_test.down": "down",
        "js.conn_test.fail": "fail",
        "js.conn_test.error": "error",
        "js.conn_test_error": "Server status check failed",
        "status.primary_config": "Primary config: {name}",
        ...
        "request.submitted": "Your request was submitted.",
        ...
        "setup.ios_apps": "WireGuard app from the App Store",
        ...
        "setup.android_apps": "WireGuard app from Google Play",
        ...
        "setup.windows_apps": "WireGuard from wireguard.com",
        ...
        "setup.macos_apps": "WireGuard app from the App Store",
        ...
        "setup.linux_apps": "WireGuard from system packages",
        ...
        "dashboard.xray_apps_hint": "Use apps like Hiddify or v2rayNG for these links — not the WireGuard app.",
        "dashboard.xray_reality": "VLESS+Reality",
        "dashboard.xray_ws": "VLESS+WebSocket",
        "dashboard.xray_ss": "Shadowsocks",
...
def js_i18n_script():
    data = {
        ...
        "connTestError": t("js.conn_test_error"),
        "connTest": {
            "wg_interface": t("js.conn_test.wg_interface"),
            "exit_ping": t("js.conn_test.exit_ping"),
            "dns": t("js.conn_test.dns"),
            "values": {
                "up": t("js.conn_test.up"),
                "ok": t("js.conn_test.ok"),
                "down": t("js.conn_test.down"),
                "fail": t("js.conn_test.fail"),
                "error": t("js.conn_test.error"),
            },
        },
        "locale": _lang(),
    }
