...
_STRINGS = {
    "fa": {
        ...
        "support.conn_test_title": "تست اتصال",
        "support.conn_test_hint": "از این ابزار برای تشخیص مشکلات شبکه استفاده کنید.",
        "support.conn_test_btn": "اجرای تست",
    ...
    "en": {
        ...
        "support.conn_test_title": "Connection test",
        "support.conn_test_hint": "Use this to diagnose network or tunnel issues.",
        "support.conn_test_btn": "Run test",
