...
Environment variables: `/etc/wireguard/entry-server.env` — see `/opt/wg-ops/config.env.example` or https://cdn.jsdelivr.net/gh/ahmadfarzad-amiri/wg@v1.0.12/deploy/config.env.example
